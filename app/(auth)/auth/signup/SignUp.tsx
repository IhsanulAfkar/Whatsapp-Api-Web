    ...
    return (<>
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <button className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50" disabled>
                    <span>
                        <svg
                            width="20"
                            height="20"
